...
import img from "../../../images/shopifyPage/7.png"
import img2 from "../../../images/shopifyPage/laptop.png"
function ShoppingCart() {
  return (
    <div>
              {/* <!------- Shopping Cart Section Start -------> */}
        <div class="shopping_cart position-relative py-md-5">
            <img src={img} alt="..." class="img-fluid py-5 cart-bg"/>
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-8 text-center py-5">
                        <h3 class="h2 fw-bold text-uppercase">Shopping Cart</h3>
                        <p>We Build shopping cart solution for Perfect for online retailers. We deliver fully
                            customizable online
                            storefront designs using a specific technological stack.</p>
                    </div>
                    <div class="col-md-10">
